@if($enable_translation)
    ...
    <p>
        ...
        <a href="#" onclick="doGTranslate('en|hi');return false;" title="Hindi" class="gflag nturl" style="background-position:-500px -100px;">
            <img src="//gtranslate.net/flags/blank.png" height="16" width="16" alt="Hindi"/>
        </a>
    ...
    <div class="d-flex justify-content-center">
        <select onchange="doGTranslate(this);" class="form-control form-control-sm d-block" style="width: auto; height:24px; padding: 2px 12px; font-size:12px; display:block">
