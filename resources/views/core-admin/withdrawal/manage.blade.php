...
@section('content')
    <div class="page-header">
        <h3>Manage Fund Withdrawals <small>(Match: {{$result_count}}; Grand Total: {{$net_count}})</small></h3>
    </div>

    <div class="panel panel-default">
        <div class="panel-heading">
            <form action="{{route('core.admin.withdrawal.manage')}}" method="GET"
                  enctype="application/x-www-form-urlencoded">
                <div class="row">
                    <div class="col-sm-12 col-lg-4">
                        <div class="form-group">
                            <label for="search">Withdrawal ID
                                <small>(search with full Withdrawal-ID or User-ID)</small>
                            </label>
                    ...
                    <div class="col-sm-5 col-lg-2">
                        <div class="form-group">
                            <label for="channel" class="small">Channel</label>
                    ...
                    <div class="col-sm-2 col-lg-2 d-none d-sm-inline-block">
                        <div class="form-group">
        ...
        <form class="ajax-form" method="post" action="{{route('core.admin.withdrawal.manage')}}">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($results as $_result)
                            <tr>
                                ...
                                <td>{{$_result->account->currency->name}}</td>
                                ...
                                <td>{{date_time_for_humans($_result->processed_at)}}</td>
                                <td>{{$_result->status()}}</td>
                                <td class="center">
                                    <a href="{{$_result->admin_url}}"><i class="fa fa-eye"></i> Details</a>
                                </td>
                                <td class="center">
            ...
            <div class="panel-footer clearfix">
                ...
                <div class="pull-right">
                    <select class="form-control d-inline btn btn-sm text-left" style="width: auto;" name="action">
                        <option></option>
                        <optgroup label="Forward actions">
                            <option value="approve">Approve Request</option>
                        </optgroup>
                        <optgroup label="Reverse actions">
                            <option value="disapprove">Disapprove Request</option>
                            <option value="decline">Decline Request (credit user's account)</option>
