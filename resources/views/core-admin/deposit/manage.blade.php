...
@section('content')
    <div class="page-header">
        <h3>Manage Fund Deposits <small>(Match: {{$result_count}}; Grand Total: {{$net_count}})</small></h3>
    </div>

    <div class="panel panel-default">
        <div class="panel-heading">
            <form action="{{route('core.admin.deposit.manage')}}" method="GET" enctype="application/x-www-form-urlencoded">
                <div class="row">
                    <div class="col-sm-12 col-lg-4">
                        <div class="form-group">
                            <label for="search">Deposit ID
                                <small>(search with full Deposit-ID or User-ID)</small>
                            </label>
        ...
        <form class="ajax-form" method="post" action="{{route('core.admin.deposit.manage')}}">
