$(function () {
    ...
    var source, handlerUrl, attribute, prefWidth, prefHeight, viewMode, initialized = false;
    var msgTimer;
    var canvasSupported = [];
    ...
    function initControls(previewer, prefWidth, prefHeight, saveHandler, modalWindow, source, viewMode, formDataModifier) {
    ...
    input.change(function () {
        ...
        if (!initialized) {
            initControls(previewer, prefWidth, prefHeight, handlerUrl, modalWindow, source, viewMode, function (formData) {
